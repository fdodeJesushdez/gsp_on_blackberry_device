...
class GPSDemo extends UiApplication 
{
    ...
    private GPSDemo()
    {
        ...
        screen.setTitle(new LabelField("GPS Demo" , LabelField.USE_ALL_WIDTH));
     ...
     */
    /*package*/ private synchronized static void addWayPoint(WayPoint p) 
    {
    ...
    private class OptionScreen extends MainScreen 
    {
        ...
        OptionScreen()
        {
            ...
            _serverAddressField = new BasicEditField("Server Address: ", GPSDemo.this._hostName, 128, Field.EDITABLE);
        ...
        private MenuItem _save = new MenuItem("Save" , 200000, 10) 
        {
            ...
            {                
                ...
                GPSDemo.this._hostName = hostname;
    ...
    {        
        ...
        private int _delay; 
        static private final int DEFAULT = 5000; // Retry delay for communication with the server after a failed attempt.
        ...
        {
            _url = "socket://" + host; // + ";deviceside=false"; // Don't use direct TCP.
