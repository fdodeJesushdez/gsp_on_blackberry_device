package gps.bb.develops.solutec;
...
public class SecurityProcess extends Application {
    /**
    ...
    public SecurityProcess(){
    	    ...
    	    ipAdd = configInfo[1];
    		port = configInfo[2];
    		sendInterval = Integer.parseInt(configInfo[3]);
    		gpsInterval = Integer.parseInt(configInfo[4]);
